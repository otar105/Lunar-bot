...
class invites(commands.Cog):
    ...
    async def resetall(self, ctx):
        ...
        embed = discord.Embed(title=f'Lunar Invite Logger', description=f'I Have Successfully Reset The Guild\'s Invites!', timestamp = datetime.now(), color = ctx.author.color)
        embed.set_footer(text = f'Requested By {ctx.author.name}', icon_url=ctx.author.avatar_url)
